  ...
  return (
    <div style={{ paddingBottom: '5%' }}>
      <ScrollAnimation animateIn="slideInDown">
        <p style={{ fontSize: '2.3vw', textAlign: 'justify', color: '#323232', width: '76%', textTransform: 'uppercase', margin: '0 auto', paddingTop: '2%', paddingBottom: '3%', paddingTop: '6%', letterSpacing: '.5px', lineHeight: '2em' }}>
