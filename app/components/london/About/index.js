...
function IntroCopy(props) {
  ...
  return (
    <div id="about_section" style={{ paddingTop: '8vh', paddingBottom: '1vh' }}>
      ...
      <ScrollAnimation animateIn="fadeIn">
        <a style={{ color: 'black', textDecoration: 'none' }}><p style={{ fontFamily: 'SuisseRegular', marginLeft: '10vw', letterSpacing: '.02em', fontSize: '1.04vw', lineHeight: '20px', color: 'black', width: '45%', paddingTop: '20vh', paddingBottom: '15vh' }}>
          {props.about}
        </p></a>
      </ScrollAnimation>
    </div>
